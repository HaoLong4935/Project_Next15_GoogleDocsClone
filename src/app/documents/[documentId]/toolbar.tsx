...
const FontSizeButton = () => {
    ...
    return (
        <div className="flex items-center gap-x-0.5">
            ...
            <button
                onClick={increment}
                className="h-7 w-7 shrink-0 flex flex-col items-center justify-center rounded-sm bg-transparent cursor-text">
...
const FontFamilyButton = () => {
    ...
    return (
        <DropdownMenu>
            {/* Vi DropdownMenuTrigger cung la mot button
            va viec content trong tag nay chua them mot button nua se gay ra loi
            nen them asChild de tang them power cho cai tag button
            */}
            <DropdownMenuTrigger asChild>
                <button
                ...
                {fonts.map(({ label, value }) => (
                    <DropdownMenuItem key={value}>
                        <button
                            ...
                            key={value}
                            className={cn("flex items-center gap-x-2 px-2 py-1 rounded-sm hover:bg-neutral-200/80", editor?.getAttributes("textStyle").fontFamily === value && "bg-neutral-200/10")}
